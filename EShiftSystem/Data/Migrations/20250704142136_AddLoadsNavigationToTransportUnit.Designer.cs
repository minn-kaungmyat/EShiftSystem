...
namespace EShiftSystem.Data.Migrations
{
    ...
    [Migration("20250704142136_AddLoadsNavigationToTransportUnit")]
    partial class AddLoadsNavigationToTransportUnit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EShiftSystem.Models.Load", b =>
                {
                    ...
                    b.Property<int?>("TransportUnitId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShiftSystem.Models.Load", b =>
                {
                    ...
                    b.HasOne("EShiftSystem.Models.TransportUnit", null)
                        .WithMany("Loads")
                        .HasForeignKey("TransportUnitId1");
